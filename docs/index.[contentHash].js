...
;// CONCATENATED MODULE: ./src/templates/frame-border-container/frame-border-container.js
...
var MyFrame = /*#__PURE__*/function (_HTMLElement) {
  _inherits(MyFrame, _HTMLElement);
  var _super = _createSuper(MyFrame);
  function MyFrame() {
    var _this;
    ...
    _defineProperty(_assertThisInitialized(_this), "value", _this.textContent);
    _defineProperty(_assertThisInitialized(_this), "margin", _this.getAttribute('margin'));
    _defineProperty(_assertThisInitialized(_this), "height", _this.getAttribute('height'));
    return _this;
  }
  _createClass(MyFrame, [{
    key: "connectedCallback",
    value: function connectedCallback() {
      this.innerHTML = "<div class='frame'>\n                    <div class='frame-container' style='height: ".concat(this.height, "'>\n                        <p class='paragraph' \n                        style='\n                            margin: ").concat(this.margin, "'>\n                            ").concat(this.value, "\n                        </p>\n                    </div>\n            </div>");
    }
  }]);
  return MyFrame;
...
document.getElementById("subscribeButton").addEventListener("click", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
  ...
  return _regeneratorRuntime().wrap(function _callee$(_context) {
    while (1) switch (_context.prev = _context.next) {
      case 0:
        ...
        _context.next = 3;
        return fetch('https://formspree.io/f/mnqkwkod', {
          method: 'POST',
          headers: {
